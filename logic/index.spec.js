...
describe("client", () => {
  it("should return a client by Id", () => {
    ...
    axios.get(`http://localhost:5000/client/id=${clientId}`).then(res => {
      debugger;
  ...
  it("should fail on invalid clientId", () => {
    ...
    axios.get(`http://localhost:5000/client/id=${clientId}`).catch(err => {
  ...
  it("should return a client by name", () => {
    ...
    axios.get(`http://localhost:5000/client/name=${name}`).then(res => {
...
describe("policy", () => {
  it("should return a policy by its Email", () => {
    ...
    axios.get(`http://localhost:5000/policy/email=${policyEmail}`).then(res => {
  ...
  it("should return a policy by Client ID", () => {
    ...
    axios.get(`http://localhost:5000/policy/clientId=${clientId}`).then(res => {
